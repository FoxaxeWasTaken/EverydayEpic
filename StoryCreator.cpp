...
ee::Story *ee::createStory(std::shared_ptr<ee::Character> heroPtr, std::shared_ptr<ee::Character> badGuyPtr)
{
    ...
    ee::Story *story96 = new ee::Story(std::string("Vous vous arretez pour l'aider.\nVous venez de le sauver. Vous etes son super-heros !"), heroPtr->getDescription() + std::string(" taking a hitchhiker in his car, in a realistic style"), std::string(""), std::string(""), heroPtr, badGuyPtr, ee::storyType::WIN);
